...
export function Footer() {
  ...
  const phoneDisplay = formatPhoneDisplay(business.whatsappPhone.raw);
            ...
            <div className="mt-6 flex gap-3">
              {business.socialMedia.instagram && (
                <a
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-primary-700 text-primary-100 transition-colors hover:bg-accent-500 hover:text-primary-900"
